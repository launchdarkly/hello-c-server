...
ARTIFACT_URL="https://github.com/launchdarkly/c-server-sdk/releases/download/$LATEST_VERSION/osx-clang-64bit-dynamic.zip"
curl -o osx-clang-64bit-dynamic.zip -L $ARTIFACT_URL
unzip osx-clang-64bit-dynamic.zip
